...
echo "Setting variables for API service..."
curl -s -X PUT \
...
curl -s -H "Authorization: Bearer $TOKEN" "https://beta-api.buildwithlocus.com/v1/variables/service/$SERVICE_ID/resolved" | jq .
